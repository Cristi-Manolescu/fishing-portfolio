...
export const despreSubsections: ArticleSubsection[] = [
	...
	{
		id: 'c2dx',
		title: 'Century C2-D X',
		excerpt: 'Century C2-D X 13,1ft 3.80lb',
		image: imgPath.despreEquipmentHero('c2dx'),
		href: '/about/c2dx',
		body: ['Century C2-D X 13,1ft 3.80lb'],
		galleryKeys: ['p01', 'p02', 'p03', 'p04', 'p05', 'p06'],
	},
	{
		id: 'quest',
		title: 'Deeper Quest',
		excerpt: 'Navomodel Deeper Quest',
	...
	},
	{
		id: 'tx5a',
		title: 'TX5-A',
		excerpt: 'Lansete Shimano TX5-A.',
		image: imgPath.despreEquipmentHero('tx5a'),
		href: '/about/tx5a',
		body: ['Lansete Shimano TX5-A'],
		galleryKeys: ['p01', 'p02', 'p03', 'p04', 'p05', 'p06'],
	},
	{
		id: 'ultegra',
		title: 'Shimano Ultegra',
		excerpt: 'Shimano Ultegra 14000 XTD',
		image: imgPath.despreEquipmentHero('ultegra'),
		href: '/about/ultegra',
		body: ['Shimano Ultegra 14000 XTD'],
		galleryKeys: ['p01', 'p02', 'p03', 'p04', 'p05', 'p06'],
	},
	{
		id: 'explorer',
...
export const lakes: Lake[] = [
	...
	},	
	{
		...
		sessions: [
			...
			{
				id: 's02',
				title: 'Varlaam, aprilie 2026',
				date: '2026',
				body: ['Varlaam, aprilie 2026'],
				galleryKeys: ['p01', 'p02', 'p03', 'p04', 'p05','p06','p07', 'p08', 'p09', 'p10', 'p11','p12', 'p13','p14'],
			},
		],
	},	
];
