...
export const THEME = {
  ...
  // NEW section using same visual language
...
export const LABELS_LTR = ["Acasa","Despre mine","Lacuri","Partide","Galerie","Contact"];
export const DRAW_ORDER = ["Contact","Galerie","Partide","Lacuri","Despre mine","Acasa"];
